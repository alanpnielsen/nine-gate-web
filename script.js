...
const translations = {
  es: {
    ...
    'hero-title-before': 'Tu operaci\u00F3n, ',
    'hero-title-accent': 'trabajando con IA.',
    'hero-subtitle': 'Dise\u00F1amos agentes, automatizaciones e integraciones que reducen tareas manuales y convierten conversaciones en acciones.',
    'hero-cta1': 'Solicitar Diagn\u00F3stico',
    'hero-cta2': 'Ver Soluciones',
    'hero-cred': 'Diagn\u00F3stico inicial\u00A0\u00B7\u00A0Implementaci\u00F3n a medida\u00A0\u00B7\u00A0Acompa\u00F1amiento real',
    'trust-1': 'Menos tareas manuales',
    'trust-2': 'Operaci\u00F3n disponible 24/7',
    'trust-3': 'Procesos listos para escalar',
    'trust-proof': 'De consulta por WhatsApp a acci\u00F3n operativa, sin pasos manuales.',
    'trust-tag-1': 'Atenci\u00F3n',
    'trust-tag-2': 'Ventas',
    'trust-tag-3': 'Operaciones',
    'trust-coming': 'Resultados y casos reales pr\u00F3ximamente',
  ...
  en: {
    ...
    'hero-title-before': 'Your operation, ',
    'hero-title-accent': 'working with AI.',
    'hero-subtitle': 'We design agents, automations and integrations that reduce manual tasks and turn conversations into actions.',
    'hero-cta1': 'Request Diagnosis',
    'hero-cta2': 'View Solutions',
    'hero-cred': 'Initial diagnosis\u00A0\u00B7\u00A0Tailored implementation\u00A0\u00B7\u00A0Real support',
    'trust-1': 'Fewer manual tasks',
    'trust-2': 'Operation available 24/7',
    'trust-3': 'Processes ready to scale',
    'trust-proof': 'From WhatsApp inquiry to operational action, without manual steps.',
    'trust-tag-1': 'Support',
    'trust-tag-2': 'Sales',
    'trust-tag-3': 'Operations',
    'trust-coming': 'Results and real cases coming soon',
