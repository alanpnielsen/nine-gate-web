...
const translations = {
  es: {
    ...
    'serv-list-desc': 'Listado consolidado de servicios Nine Gate: auditor\u00EDa, automatizaciones y acompa\u00F1amiento.',
  ...
  en: {
    ...
    'serv-card1-title': 'Audit',
    'serv-card1-desc': 'Complete analysis of business processes to identify automation opportunities.',
    'serv-card2-title': 'Automation',
    'serv-card2-desc': 'Implementation of automated workflows with AI and tools such as n8n.',
    'serv-card3-title': 'Support',
    'serv-card3-desc': 'Continuous support and optimization of already implemented processes.',
    ...
    'serv-list-desc': 'Consolidated list of Nine Gate services: auditing, automations and support.',
