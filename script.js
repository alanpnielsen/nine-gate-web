...
const translations = {
  es: {
    ...
    'sol-list-link': 'Ver cómo se implementan estos servicios',
    'sol-cases-link': 'Ver casos de uso aplicados por área',
    ...
    'como-list-link': 'Conocé los servicios que implementamos con esta metodología',
    'step-0-title': 'Brief',
    ...
    'serv-more-link': 'Conoc\u00E9 todos nuestros servicios de automatizaci\u00F3n',
    'ben-tag': 'Beneficios',
    ...
    'about-link': 'Así trabajamos en cada proyecto',
    ...
    'contact-link': 'Ver casos de uso de automatizaci\u00F3n',
    ...
    'serv-intro': 'La automatizaci\u00F3n de procesos permite que el software se haga cargo de tareas repetitivas como la clasificaci\u00F3n de documentos, el seguimiento de leads, la gesti\u00F3n de presupuestos y las alertas internas, con IA y supervisi\u00F3n humana cuando hace falta.',
    'serv-list-link': 'Ver casos de uso de automatizaci\u00F3n por \u00E1rea',
    'serv-flow-link': 'Conoc\u00E9 c\u00F3mo trabajamos en cada proyecto',
    ...
    'home-cases-cta': 'Explorar todos los casos de uso',
    'cu-tag': 'Casos de uso',
    'cu-hero-title-before': 'IA aplicada a ',
    'cu-hero-title-accent': 'procesos reales.',
    'cu-hero-desc': 'Descubr\u00ED c\u00F3mo la inteligencia artificial, la automatizaci\u00F3n y los sistemas inteligentes pueden transformar distintas \u00E1reas de tu empresa.',
    'cu-hero-quote': 'No implementamos IA porque s\u00ED. Identificamos procesos, conectamos sistemas y dise\u00F1amos soluciones para generar resultados reales.',
    'cu-hero-cta1': 'Explorar casos de uso',
    'cu-hero-cta2': 'Hablar con Nine Gate',
    'cu-prob-title': 'Cada empresa tiene procesos que pueden funcionar mejor.',
    'cu-prob-desc': 'Tareas manuales. Sistemas desconectados. Informaci\u00F3n dispersa. Procesos que dependen de personas para pasar datos de una herramienta a otra.',
    'cu-n-ppl': 'Personas',
    'cu-n-db': 'Bases de datos',
    'cu-res1': 'Procesos inteligentes',
    'cu-res2': 'Operaciones conectadas',
    'cu-res3': 'Automatizaci\u00F3n',
    'cu-prob-quote': 'Nine Gate identifica esas oportunidades y transforma procesos tradicionales en sistemas m\u00E1s inteligentes, conectados y automatizados.',
    'cu-areas-tag': '\u00C1reas que transformamos',
    'cu-areas-title-before': '\u00C1reas que ',
    'cu-areas-title-accent': 'transformamos',
    'cu-areas-desc': 'Aplicaci\u00F3n pr\u00E1ctica de IA, automatizaci\u00F3n e integraci\u00F3n en cada \u00E1rea de la empresa.',
    'cu-a1-name': 'Ventas',
    'cu-a1-desc': 'Automatizaci\u00F3n de calificaci\u00F3n de leads, seguimiento comercial y procesos de venta.',
    'cu-a1-c1': 'Lead scoring autom\u00E1tico',
    'cu-a1-c2': 'Seguimiento inteligente',
    'cu-a1-c3': 'Agentes comerciales',
    'cu-a1-c4': 'Sincronizaci\u00F3n CRM',
    'cu-a1-c5': 'Priorizaci\u00F3n de oportunidades',
    'cu-a2-name': 'Atenci\u00F3n al Cliente',
    'cu-a2-desc': 'Respuestas instant\u00E1neas, resoluci\u00F3n de consultas y derivaci\u00F3n inteligente.',
    'cu-a2-c1': 'Atenci\u00F3n 24/7',
    'cu-a2-c2': 'Asistentes con conocimiento empresarial',
    'cu-a2-c3': 'Clasificaci\u00F3n autom\u00E1tica',
    'cu-a2-c4': 'Integraci\u00F3n con CRM',
    'cu-a2-c5': 'Escalamiento a humanos',
    'cu-a3-name': 'Recursos Humanos',
    'cu-a3-desc': 'Automatizaci\u00F3n de procesos para atraer, evaluar e incorporar talento.',
    'cu-a3-c1': 'Filtrado de postulantes',
    'cu-a3-c2': 'Screening inicial',
    'cu-a3-c3': 'Automatizaci\u00F3n de entrevistas',
    'cu-a3-c4': 'Onboarding',
    'cu-a3-c5': 'B\u00FAsqueda de talento en Latinoam\u00E9rica',
    'cu-a4-name': 'Marketing',
    'cu-a4-desc': 'IA aplicada a contenido, audiencias y an\u00E1lisis de resultados.',
    'cu-a4-c1': 'Generaci\u00F3n asistida de contenido',
    'cu-a4-c2': 'Segmentaci\u00F3n',
    'cu-a4-c3': 'Automatizaci\u00F3n de campa\u00F1as',
    'cu-a4-c4': 'An\u00E1lisis de datos',
    'cu-a4-c5': 'Clasificaci\u00F3n de audiencias',
    'cu-a5-name': 'Operaciones',
    'cu-a5-desc': 'Conectamos sistemas y reducimos procesos manuales.',
    'cu-a5-c1': 'Integraciones',
    'cu-a5-c2': 'Workflows',
    'cu-a5-c3': 'Automatizaci\u00F3n de reportes',
    'cu-a5-c4': 'Control operativo',
    'cu-a5-c5': 'Alertas inteligentes',
    'cu-a6-name': 'Log\u00EDstica y Distribuci\u00F3n',
    'cu-a6-desc': 'Informaci\u00F3n conectada para una operaci\u00F3n m\u00E1s eficiente.',
    'cu-a6-c1': 'Gesti\u00F3n inteligente de pedidos',
    'cu-a6-c2': 'Seguimiento de entregas',
    'cu-a6-c3': 'Automatizaci\u00F3n documental',
    'cu-a6-c4': 'Integraci\u00F3n de inventario',
    'cu-a6-c5': 'Alertas y coordinaci\u00F3n',
    'cu-a7-name': 'Administraci\u00F3n y Finanzas',
    'cu-a7-desc': 'Automatizaci\u00F3n de tareas administrativas y an\u00E1lisis de informaci\u00F3n.',
    'cu-a7-c1': 'Procesamiento de documentos',
    'cu-a7-c2': 'Extracci\u00F3n de datos',
    'cu-a7-c3': 'Reportes autom\u00E1ticos',
    'cu-a7-c4': 'Conciliaci\u00F3n de informaci\u00F3n',
    'cu-a7-c5': 'Detecci\u00F3n de inconsistencias',
    'cu-a8-name': 'Direcci\u00F3n y Gesti\u00F3n',
    'cu-a8-desc': 'Convertimos datos dispersos en informaci\u00F3n \u00FAtil para decidir.',
    'cu-a8-c1': 'Reportes ejecutivos',
    'cu-a8-c2': 'Dashboards inteligentes',
    'cu-a8-c3': 'An\u00E1lisis de indicadores',
    'cu-a8-c4': 'Alertas estrat\u00E9gicas',
    'cu-a8-c5': 'Res\u00FAmenes autom\u00E1ticos',
    'cu-a9-name': 'Industria y Mantenimiento',
    'cu-a9-desc': 'IA y automatizaci\u00F3n para procesos operativos complejos.',
    'cu-a9-c1': 'Monitoreo de informaci\u00F3n',
    'cu-a9-c2': 'Alertas operativas',
    'cu-a9-c3': 'An\u00E1lisis de procesos',
    'cu-a9-c4': 'Mantenimiento predictivo',
    'cu-a9-c5': 'Gesti\u00F3n documental t\u00E9cnica',
    'cu-cr-title-before': 'Un proceso puede cruzar toda tu ',
    'cu-cr-title-accent': 'empresa.',
    'cu-cr-desc': 'Una sola automatizaci\u00F3n puede conectar ventas, atenci\u00F3n al cliente, operaciones y sistemas internos.',
    'cu-cr-s1': 'Cliente escribe por WhatsApp',
    'cu-cr-s2': 'Nine Gate Agent interpreta la consulta',
    'cu-cr-s3': 'Consulta el ERP',
    'cu-cr-s4': 'Verifica stock',
    'cu-cr-s5': 'Actualiza el CRM',
    'cu-cr-s6': 'Responde al cliente',
    'cu-cr-s7': 'Genera una oportunidad comercial',
    'cu-cr-note': 'Una sola automatizaci\u00F3n conecta comunicaci\u00F3n, sistemas internos y \u00E1rea comercial: cada mensaje termina convertido en informaci\u00F3n ordenada y accionable.',
    'cu-how-tag': 'Oportunidades',
    'cu-how-title-before': 'No empezamos por la ',
    'cu-how-title-accent': 'tecnolog\u00EDa.',
    'cu-how-desc': 'Primero entendemos la operaci\u00F3n. Despu\u00E9s decidimos d\u00F3nde aplicar IA, automatizaci\u00F3n e integraci\u00F3n.',
    'cu-o1-t': 'Entendemos',
    'cu-o1-d': 'Analizamos el proceso y c\u00F3mo funciona actualmente.',
    'cu-o2-t': 'Identificamos',
    'cu-o2-d': 'Detectamos tareas manuales, cuellos de botella y sistemas desconectados.',
    'cu-o3-t': 'Dise\u00F1amos',
    'cu-o3-d': 'Definimos qu\u00E9 automatizar, qu\u00E9 integrar y d\u00F3nde aplicar IA.',
    'cu-o4-t': 'Construimos',
    'cu-o4-d': 'Implementamos la soluci\u00F3n.',
    'cu-o5-t': 'Medimos',
    'cu-o5-d': 'Analizamos resultados y optimizamos.',
    'cu-te-tag': 'Tecnolog\u00EDa',
    'cu-te-title-before': 'La mejor tecnolog\u00EDa depende del ',
    'cu-te-title-accent': 'problema.',
    'cu-te-desc': 'Nine Gate combina inteligencia artificial, agentes, automatizaci\u00F3n, APIs e integraciones para construir la soluci\u00F3n adecuada para cada operaci\u00F3n.',
    'cu-cta-title': '\u00BFTu \u00E1rea no aparece en la lista?',
    'cu-cta-desc': 'Contanos c\u00F3mo funciona tu operaci\u00F3n. Analizamos d\u00F3nde la inteligencia artificial y la automatizaci\u00F3n pueden generar impacto.',
    'cu-cta-btn': 'Analizar mi operaci\u00F3n',
    'sales-tag': 'Automatizaci\u00F3n de ventas',
    'sales-title': 'Automatizaci\u00F3n del proceso de ventas con IA',
    'sales-intro': 'Los equipos comerciales pierden tiempo respondiendo consultas, calificando leads, actualizando el CRM y haciendo seguimientos manuales. En Nine Gate automatizamos esas etapas del proceso de ventas con inteligencia artificial e integraci\u00F3n con los sistemas que ya us\u00E1s, manteniendo supervisi\u00F3n humana cuando hace falta.',
    'sales-cta-top': 'Solicitar diagn\u00F3stico',
    'sales-link-servicios': 'Conoc\u00E9 nuestros servicios de automatizaci\u00F3n',
    'sales-what-title': '\u00BFQu\u00E9 podemos automatizar en tu proceso de ventas?',
    'sales-step1-title': 'Captura de leads',
    'sales-step1-desc': 'Captaci\u00F3n desde WhatsApp, formularios y otros canales.',
    'sales-step2-title': 'Calificaci\u00F3n autom\u00E1tica',
    'sales-step2-desc': 'La IA analiza consultas y clasifica oportunidades seg\u00FAn criterios definidos.',
    'sales-step3-title': 'Seguimiento',
    'sales-step3-desc': 'Recordatorios y acciones de seguimiento automatizados.',
    'sales-step4-title': 'Actualizaci\u00F3n del CRM',
    'sales-step4-desc': 'Los datos de conversaciones y oportunidades se registran autom\u00E1ticamente.',
    'sales-step5-title': 'Derivaci\u00F3n al equipo comercial',
    'sales-step5-desc': 'Las conversaciones que requieren criterio humano pasan al equipo.',
    'sales-flow-title': 'C\u00F3mo funciona',
    'sales-flow-desc': 'De la consulta a la oportunidad, un flujo que coordina canales, IA, CRM y tu equipo.',
    'sales-f1': 'Lead',
    'sales-f1-desc': 'Ingresa una consulta o un nuevo contacto.',
    'sales-f2': 'WhatsApp / Web',
    'sales-f2-desc': 'Llega por el canal que prefiera tu cliente.',
    'sales-f3': 'IA',
    'sales-f3-desc': 'Interpreta la consulta y extrae la informaci\u00F3n.',
    'sales-f4': 'Calificaci\u00F3n',
    'sales-f4-desc': 'Clasifica la oportunidad seg\u00FAn tus criterios.',
    'sales-f5': 'CRM',
    'sales-f5-desc': 'Registra y actualiza el contacto autom\u00E1ticamente.',
    'sales-f6': 'Seguimiento',
    'sales-f6-desc': 'Dispara recordatorios y pr\u00F3ximas acciones.',
    'sales-f7': 'Vendedor',
    'sales-f7-desc': 'Interviene cuando se necesita criterio humano.',
    'sales-flow-note': 'Ventas, atenci\u00F3n, operaci\u00F3n y sistemas conectados en un solo recorrido.',
    'sales-ai-title': 'Automatizaci\u00F3n de ventas con IA',
    'sales-ai-desc': 'No se trata de un simple chatbot: es un sistema que coordina las etapas del proceso comercial.',
    'sales-ai-p1': 'Una soluci\u00F3n de automatizaci\u00F3n de ventas con IA puede conversar con tus clientes, clasificar consultas, extraer informaci\u00F3n clave, preparar respuestas y aplicar reglas de negocio. Se integra con tu CRM, dispara automatizaciones y deja lugar a la intervenci\u00F3n humana cuando hace falta criterio.',
    'sales-ai-p2': 'El foco est\u00E1 en que cada etapa del proceso de ventas se ejecute de forma ordenada: reunir la informaci\u00F3n, procesarla con IA y conectarla con el resto de tu operaci\u00F3n.',
    'sales-link-como': 'Conoc\u00E9 c\u00F3mo trabajamos',
    'sales-ben-title': 'Beneficios para tu equipo comercial',
    'sales-ben1-title': 'Menos trabajo manual',
    'sales-ben1-desc': 'El sistema se ocupa de las tareas repetitivas.',
    'sales-ben2-title': 'Respuesta m\u00E1s r\u00E1pida',
    'sales-ben2-desc': 'Cada consulta se atiende sin demoras.',
    'sales-ben3-title': 'Menos oportunidades perdidas',
    'sales-ben3-desc': 'Ning\u00FAn lead queda sin seguimiento.',
    'sales-ben4-title': 'Informaci\u00F3n ordenada',
    'sales-ben4-desc': 'Todo queda registrado y accionable.',
    'sales-ben5-title': 'M\u00E1s control del proceso',
    'sales-ben5-desc': 'Ves cada etapa y sab\u00E9s qu\u00E9 sigue.',
    'sales-for-title': '\u00BFPara qu\u00E9 empresas sirve?',
    'sales-for-desc': 'Una soluci\u00F3n de automatizaci\u00F3n de ventas puede adaptarse, en especial, a empresas que reciben consultas y oportunidades comerciales por WhatsApp, formularios u otros canales.',
    'sales-link-casos': 'Ver casos de uso aplicados por \u00E1rea',
    'sales-int-title': 'Integraciones',
    'sales-int-desc': 'Simple y conectado con tu stack: viene a ordenar tu proceso comercial.',
    'sales-int-1': 'WhatsApp',
    'sales-int-2': 'IA',
    'sales-int-3': 'CRM',
    'sales-int-4': 'n8n',
    'sales-int-5': 'Bases de datos',
    'sales-int-6': 'Dashboards',
    'sales-link-soluciones': 'Explorar otras soluciones de automatizaci\u00F3n',
    'sales-cta-title': '\u00BFQuer\u00E9s automatizar tu proceso de ventas?',
    'sales-cta-desc': 'Contanos c\u00F3mo funciona actualmente tu proceso comercial y detectamos qu\u00E9 tareas pueden automatizarse.',
    'sales-cta-btn': 'Solicitar diagn\u00F3stico',
  },
  en: {
    ...
    'sol-list-link': 'See how these services are implemented',
    'sol-cases-link': 'See use cases applied by area',
    ...
    'como-list-link': 'Explore the services we implement with this methodology',
    'step-0-title': 'Brief',
    ...
    'serv-more-link': 'Explore all our automation services',
    'ben-tag': 'Benefits',
    ...
    'about-link': 'This is how we work on every project',
    ...
    'contact-link': 'See automation use cases',
    ...
    'serv-intro': 'Process automation lets software handle repetitive tasks such as document classification, lead follow-up, quote management and internal alerts, working with AI and human oversight when needed.',
    'serv-list-link': 'See automation use cases by area',
    'serv-flow-link': 'Learn how we work on each project',
    ...
    'home-cases-cta': 'Explore all use cases',
    'cu-tag': 'Use Cases',
    'cu-hero-title-before': 'AI applied to ',
    'cu-hero-title-accent': 'real processes.',
    'cu-hero-desc': 'Discover how artificial intelligence, automation and intelligent systems can transform different areas of your company.',
    'cu-hero-quote': 'We don\u2019t implement AI just for the sake of it. We identify processes, connect systems and design solutions to generate real results.',
    'cu-hero-cta1': 'Explore use cases',
    'cu-hero-cta2': 'Talk to Nine Gate',
    'cu-prob-title': 'Every company has processes that could work better.',
    'cu-prob-desc': 'Manual tasks. Disconnected systems. Scattered information. Processes that depend on people to move data from one tool to another.',
    'cu-n-ppl': 'People',
    'cu-n-db': 'Databases',
    'cu-res1': 'Intelligent processes',
    'cu-res2': 'Connected operations',
    'cu-res3': 'Automation',
    'cu-prob-quote': 'Nine Gate identifies those opportunities and transforms traditional processes into smarter, connected and automated systems.',
    'cu-areas-tag': 'Areas we transform',
    'cu-areas-title-before': 'Areas we ',
    'cu-areas-title-accent': 'transform',
    'cu-areas-desc': 'Practical application of AI, automation and integration across every area of the company.',
    'cu-a1-name': 'Sales',
    'cu-a1-desc': 'Lead qualification automation, commercial follow-up and sales processes.',
    'cu-a1-c1': 'Automatic lead scoring',
    'cu-a1-c2': 'Smart follow-up',
    'cu-a1-c3': 'Sales agents',
    'cu-a1-c4': 'CRM synchronization',
    'cu-a1-c5': 'Opportunity prioritization',
    'cu-a2-name': 'Customer Support',
    'cu-a2-desc': 'Instant responses, query resolution and smart routing.',
    'cu-a2-c1': '24/7 support',
    'cu-a2-c2': 'Assistants with company knowledge',
    'cu-a2-c3': 'Automatic classification',
    'cu-a2-c4': 'CRM integration',
    'cu-a2-c5': 'Escalation to humans',
    'cu-a3-name': 'Human Resources',
    'cu-a3-desc': 'Process automation to attract, evaluate and onboard talent.',
    'cu-a3-c1': 'Applicant filtering',
    'cu-a3-c2': 'Initial screening',
    'cu-a3-c3': 'Interview automation',
    'cu-a3-c4': 'Onboarding',
    'cu-a3-c5': 'Talent sourcing in Latin America',
    'cu-a4-name': 'Marketing',
    'cu-a4-desc': 'AI applied to content, audiences and results analysis.',
    'cu-a4-c1': 'Assisted content generation',
    'cu-a4-c2': 'Segmentation',
    'cu-a4-c3': 'Campaign automation',
    'cu-a4-c4': 'Data analysis',
    'cu-a4-c5': 'Audience classification',
    'cu-a5-name': 'Operations',
    'cu-a5-desc': 'We connect systems and reduce manual processes.',
    'cu-a5-c1': 'Integrations',
    'cu-a5-c2': 'Workflows',
    'cu-a5-c3': 'Report automation',
    'cu-a5-c4': 'Operations control',
    'cu-a5-c5': 'Smart alerts',
    'cu-a6-name': 'Logistics & Distribution',
    'cu-a6-desc': 'Connected information for a more efficient operation.',
    'cu-a6-c1': 'Smart order management',
    'cu-a6-c2': 'Delivery tracking',
    'cu-a6-c3': 'Document automation',
    'cu-a6-c4': 'Inventory integration',
    'cu-a6-c5': 'Alerts and coordination',
    'cu-a7-name': 'Administration & Finance',
    'cu-a7-desc': 'Administrative task automation and information analysis.',
    'cu-a7-c1': 'Document processing',
    'cu-a7-c2': 'Data extraction',
    'cu-a7-c3': 'Automatic reports',
    'cu-a7-c4': 'Information reconciliation',
    'cu-a7-c5': 'Inconsistency detection',
    'cu-a8-name': 'Management & Direction',
    'cu-a8-desc': 'We turn scattered data into useful decision-making information.',
    'cu-a8-c1': 'Executive reports',
    'cu-a8-c2': 'Smart dashboards',
    'cu-a8-c3': 'KPI analysis',
    'cu-a8-c4': 'Strategic alerts',
    'cu-a8-c5': 'Automatic summaries',
    'cu-a9-name': 'Industry & Maintenance',
    'cu-a9-desc': 'AI and automation for complex operational processes.',
    'cu-a9-c1': 'Information monitoring',
    'cu-a9-c2': 'Operational alerts',
    'cu-a9-c3': 'Process analysis',
    'cu-a9-c4': 'Predictive maintenance',
    'cu-a9-c5': 'Technical document management',
    'cu-cr-title-before': 'One process can run through your whole ',
    'cu-cr-title-accent': 'company.',
    'cu-cr-desc': 'A single automation can connect sales, customer support, operations and internal systems.',
    'cu-cr-s1': 'Client writes on WhatsApp',
    'cu-cr-s2': 'Nine Gate Agent understands the request',
    'cu-cr-s3': 'Checks the ERP',
    'cu-cr-s4': 'Verifies stock',
    'cu-cr-s5': 'Updates the CRM',
    'cu-cr-s6': 'Replies to the client',
    'cu-cr-s7': 'Creates a sales opportunity',
    'cu-cr-note': 'A single automation connects communication, internal systems and the commercial area: every message ends up as organized, actionable information.',
    'cu-how-tag': 'Opportunities',
    'cu-how-title-before': 'We don\u2019t start with ',
    'cu-how-title-accent': 'technology.',
    'cu-how-desc': 'First we understand the operation. Then we decide where to apply AI, automation and integration.',
    'cu-o1-t': 'Understand',
    'cu-o1-d': 'We analyze the process and how it currently works.',
    'cu-o2-t': 'Identify',
    'cu-o2-d': 'We detect manual tasks, bottlenecks and disconnected systems.',
    'cu-o3-t': 'Design',
    'cu-o3-d': 'We define what to automate, what to integrate and where to apply AI.',
    'cu-o4-t': 'Build',
    'cu-o4-d': 'We implement the solution.',
    'cu-o5-t': 'Measure',
    'cu-o5-d': 'We analyze results and optimize.',
    'cu-te-tag': 'Technology',
    'cu-te-title-before': 'The best technology depends on the ',
    'cu-te-title-accent': 'problem.',
    'cu-te-desc': 'Nine Gate combines artificial intelligence, agents, automation, APIs and integrations to build the right solution for each operation.',
    'cu-cta-title': 'Is your area not on the list?',
    'cu-cta-desc': 'Tell us how your operation works. We analyze where artificial intelligence and automation can generate impact.',
    'cu-cta-btn': 'Analyze my operation',
    'sales-tag': 'Sales automation',
    'sales-title': 'AI sales process automation',
    'sales-intro': 'Sales teams waste time answering inquiries, qualifying leads, updating the CRM and doing manual follow-ups. At Nine Gate we automate those stages of the sales process with artificial intelligence and integration with the systems you already use, keeping human oversight when needed.',
    'sales-cta-top': 'Request a diagnosis',
    'sales-link-servicios': 'Explore our automation services',
    'sales-what-title': 'What can we automate in your sales process?',
    'sales-step1-title': 'Lead capture',
    'sales-step1-desc': 'Capture from WhatsApp, forms and other channels.',
    'sales-step2-title': 'Automatic qualification',
    'sales-step2-desc': 'AI analyzes inquiries and classifies opportunities according to defined criteria.',
    'sales-step3-title': 'Follow-up',
    'sales-step3-desc': 'Automated reminders and follow-up actions.',
    'sales-step4-title': 'CRM updates',
    'sales-step4-desc': 'Conversation and opportunity data is recorded automatically.',
    'sales-step5-title': 'Handoff to the sales team',
    'sales-step5-desc': 'Conversations that need human judgment go to the team.',
    'sales-flow-title': 'How it works',
    'sales-flow-desc': 'From inquiry to opportunity, a flow that coordinates channels, AI, CRM and your team.',
    'sales-f1': 'Lead',
    'sales-f1-desc': 'An inquiry or new contact comes in.',
    'sales-f2': 'WhatsApp / Web',
    'sales-f2-desc': 'It arrives through the channel your client prefers.',
    'sales-f3': 'AI',
    'sales-f3-desc': 'Interprets the inquiry and extracts the information.',
    'sales-f4': 'Qualification',
    'sales-f4-desc': 'Classifies the opportunity according to your criteria.',
    'sales-f5': 'CRM',
    'sales-f5-desc': 'Registers and updates the contact automatically.',
    'sales-f6': 'Follow-up',
    'sales-f6-desc': 'Triggers reminders and next actions.',
    'sales-f7': 'Salesperson',
    'sales-f7-desc': 'Steps in when human judgment is needed.',
    'sales-flow-note': 'Sales, customer service, operations and systems connected in one journey.',
    'sales-ai-title': 'AI sales automation',
    'sales-ai-desc': 'It is not a simple chatbot: it is a system that coordinates the stages of the sales process.',
    'sales-ai-p1': 'An AI sales automation solution can talk to your customers, classify inquiries, extract key information, prepare responses and apply business rules. It integrates with your CRM, triggers automations and leaves room for human intervention when judgment is needed.',
    'sales-ai-p2': 'The focus is on executing every stage of the sales process in an orderly way: gathering the information, processing it with AI and connecting it with the rest of your operation.',
    'sales-link-como': 'Find out how we work',
    'sales-ben-title': 'Benefits for your sales team',
    'sales-ben1-title': 'Less manual work',
    'sales-ben1-desc': 'The system handles repetitive tasks.',
    'sales-ben2-title': 'Faster responses',
    'sales-ben2-desc': 'Every inquiry is handled without delay.',
    'sales-ben3-title': 'Fewer lost opportunities',
    'sales-ben3-desc': 'No lead is left without follow-up.',
    'sales-ben4-title': 'Organized information',
    'sales-ben4-desc': 'Everything is recorded and actionable.',
    'sales-ben5-title': 'More process control',
    'sales-ben5-desc': 'You see every stage and know what comes next.',
    'sales-for-title': 'Which companies is it for?',
    'sales-for-desc': 'An AI sales automation solution can adapt, especially, to companies that receive commercial inquiries and opportunities through WhatsApp, forms or other channels.',
    'sales-link-casos': 'See use cases applied by area',
    'sales-int-title': 'Integrations',
    'sales-int-desc': 'Simple and connected with your stack: it comes to organize your sales process.',
    'sales-int-1': 'WhatsApp',
    'sales-int-2': 'AI',
    'sales-int-3': 'CRM',
    'sales-int-4': 'n8n',
    'sales-int-5': 'Databases',
    'sales-int-6': 'Dashboards',
    'sales-link-soluciones': 'Explore other automation solutions',
    'sales-cta-title': 'Do you want to automate your sales process?',
    'sales-cta-desc': 'Tell us how your sales process works today and we will detect which tasks can be automated.',
    'sales-cta-btn': 'Request a diagnosis',
  }
};
